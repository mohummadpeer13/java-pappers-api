...
public class Etablissement {
	...
	public String toString() {
		return "Etablissement [siret=" + siret + ", siret_formate=" + siret_formate + ", nic=" + nic + ", numero_voie="
				...
				+ code_naf + ", libelle_code_naf=" + libelle_code_naf + ", etablissement_employeur="
				+ etablissement_employeur + ", effectif=" + effectif + ", effectif_min=" + effectif_min
				+ ", effectif_max=" + effectif_max + ", tranche_effectif=" + tranche_effectif + ", annee_effectif="
				+ annee_effectif + ", date_de_creation=" + date_de_creation + ", etablissement_cesse="
				+ etablissement_cesse + ", date_cessation=" + date_cessation + ", domiciliation=" + domiciliation
				+ ", siege=" + siege + "]";
	}	
}
